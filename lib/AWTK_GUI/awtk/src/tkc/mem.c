...
#include "mem.h"
#include "time_now.h"
#include "mem_allocator_oom.h"
#include "mem_allocator_pool.h"

static mem_allocator_oom_t s_oom;

#ifdef ENABLE_MEM_LEAK_CHECK
#include "mem_allocator_debug.h"
...
#include "mem_allocator_std.h"

#ifdef ENABLE_MEM_LEAK_CHECK
#include "mem_allocator_lock.h"
...
#include "mem_allocator_lock.h"
#include "mem_allocator_composite.h"
